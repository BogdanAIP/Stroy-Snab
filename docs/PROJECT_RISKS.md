...
| `PRIVATE_DATA_LEAK` | публичный repo/CI раскрывает реальные документы/реквизиты/цены | private corpus outside Git, redacted fixtures, `.gitignore`, review checks |
...
| `EVAL_CONTAMINATION` | система оптимизирована под известные документы и метрики лгут | holdout/private split, immutable case identities, baseline comparisons |
